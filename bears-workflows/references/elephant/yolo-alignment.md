...
- Trained YOLO model at `bears-skills/bears-workflows/references/elephant/yolov8n.pt` that can detect:
...
```bash
python -m elephant_driver.combined_viewer --pi-ip 192.168.50.128 --start-pi-stream --pi-stream-port 5000 --workdir reports/elephant_camera --cam2-stream-url rtsp://100.125.227.14:8554/livestream --yolo-model-path bears-skills/bears-workflows/references/elephant/yolov8n.pt
```
